...
HD_PWD='C:/Users/aksha/Desktop/riscv_singlecycle/riscv_singlecycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ssdcontroller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ssdcontroller.tcl
