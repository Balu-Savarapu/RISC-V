...
HD_PWD='C:/Users/aksha/Desktop/riscv_singlecycle/riscv_singlecycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ssdcontroller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ssdcontroller.tcl -notrace
